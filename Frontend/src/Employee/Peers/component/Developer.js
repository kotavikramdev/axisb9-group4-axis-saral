...
function Developer(props) {
    ...
    async function getEmployeeData() {
        await axios.get(
            `${baseUrl}/employees-by-designation/Developer`,
            {
                'headers': {
    ...
    return (
        <div className={classes.bo}>
            <h2 class="text-center" style={styleHeading}><b>Developers</b></h2>
                                ...
                                <div className="col-md-3">
                                    <div className="card shadow-lg d-flex" >
                                        <div className={classes.card}>
                                            <EmployeeImage employeeId={employee['employeeId']} designation='Developer' />
                                            {/* <img src={require('../../../Images/ProfileImage.png')} className={classes.img} alt="developer" /> */}
